...
#define DATA_PIN 3   // LED Steuerung kommt in Pin 6
//int ledInner = 21;    // 21 LEDs für den Inneren
int ledInner = 10;    // 21 LEDs für den Inneren
// int ledOuter = 32;    // 32 LEDs für den Äußeren
int ledOuter = 10;    // 32 LEDs für den Äußeren
int ledStrip = 40;    // X LEDs für LED Kette
