...
void inputFunctionJoystick()
{
    ...
    Serial.print(input.force); // debug
    Serial.print(" ");         // debug
...
void feedbackLEDRingColor()
{
    ...
    if (input.bottleActive)
    {
        ...
        if (!input.bottleTilted)
        {
            ...
            // Innenren Ring Modus Farbe färben
            setLED(
                0,
                0, ledInner,
                output.partyModeColor[output.partyMode], 255, 255,
...
void feedbackLEDPressFeedback()
{
    ...
    if (input.bottleActive)
    {
        ...
        if (input.buttonOnOff[1] == round(maximum / 3 * 2))
        {
        ...
        if (input.buttonOnOff[1] <= maximum)
        {
            ...
            // Überarbeitung Dominik: Animation des Moduswechsel
            setLED(
                0,
                0, ledInner,
                output.partyModeColor[output.partyMode], 255, 255,
            ...
            // // Überarbeitung Dominik: Anzeige des Modus auf Ring
            // setLED(
            //     1,
            //     0, ledOuter,
            //     0, 0, 255,
            ...
            // for (size_t i = 0; i < ledOuter / 8; i++)
            // {
            //     // jedes x.te anzeigen
            //     setLED(
            //         1,
            //         i * 8, (output.partyMode + 1) * 2,
            //         output.partyModeColor[output.partyMode], 255, 255,
            //         false);
            // }
